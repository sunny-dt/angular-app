...
export class ProductComponent implements OnInit {
  ...
  constructor( private apiService: ApiService, private location: Location, public iconRegistry: MatIconRegistry,
    public sanitizer: DomSanitizer, private elem: ElementRef, private router: Router, private route: ActivatedRoute,
    public dialog: MatDialog, private appComp: AppComponent, private storageService: StorageService) {
  ...
  startSpinnerUpdateTimer() {
    ...
    this.interval = setInterval(() => {
      ...
      if(this.timeLeft == 4) {
        ...
        this.timeLeft++;
        this.spinnerValue = this.timeLeft * 25;
